export default {
  HOME: {
    HEADER: {
      ...
      DESCRIPTION_TEXT_1:
        'Progressive Overload belirli bir dönem içinde sürekli olarak <b>ağırlık/tekrar </b> arttırarak <b>güç ve kas</b> kazanımında fayda sağlayan bir metoddur.',
  ...
  WORKOUTS: {
    LIST: {
      TITLE: 'Antrenmanlar',
      DESCRIPTION:
        'Antrenmanların burada listelenir yeni antrenman ekleyebilir ve bunların içine antrenman günleri ve hareketler ekleyebilirsin.',
    ...
    ADD: {
      ...
      DESCRIPTION:
        'Antrenmanına günler ekleyebilir ,günlere isim verebilir, antrenman anında bu günlere direkt tıklayarak erişebilirsin!'
    },
    EDIT: {
      BACK_WORKOUTS: 'Antrenmanlara Dön',
  ...
  RESET_PASSWORD: {
    TITLE: 'Şifre Yenile',
    DESCRIPTION:
      'Şifre oluştururken en az 6 karakter, büyük ve küçük harflerden oluşmasına dikkat etmelisiniz. Zorunlu değil sadece tavsiye 🙃',
    FORM: {
      CURRENT_PASSWORD: {
        LABEL: 'Mevcut Şifre',
  ...
  AUTH: {
    ...
    FORGOT_PASSWORD: {
      ...
      DESCRIPTION:
        'Lütfen giriş yapmaya çalıştığınız hesabın e-posta adresini giriniz. Şifre sıfırlama bağlantısı e-posta adresinize gönderilecektir.',
      FORM_SUBMIT: 'Mail Gönder',
      SUCCESS_MESSAGE:
        'Şifre yenileme linkini E-Posta adresine gönderdik! E-Posta adresini kontrol ederek şifreni yenileyebilirsin.'
    },
    RESET_PASSWORD: {
      TITLE: 'Şifre Yenile',
      DESCRIPTION:
        'Görünüşe göre e-posta adersinize gönderdiğimiz mesajı aldınız 🎉 Şimdi yeni şifrenizi oluşturabilirsiniz.',
  ...
  WORKOUT_COMPLETED: {
    ...
    MOTIVATON_TEXT:
      'Bu gün de antrenmanını aksatmadın ve tüm çabanla çalıştın! Bu gün dünden daha iyisin, yarın bugünden daha iyi olacaksın!',
