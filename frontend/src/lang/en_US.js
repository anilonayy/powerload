export default {
  HOME: {
    HEADER: {
      ...
      DESCRIPTION_TEXT_1:
        'Progressive Overload is a method that provides benefits in <b>strength and muscle</b> gain by continuously increasing <b>weight/reps</b> over a period of time.',
  ...
  WORKOUTS: {
    ...
    ADD: {
      ...
      TITLE: 'Add Workout',
      DESCRIPTION:
        'You can add days to your workout, name them, and access them during workout by clicking on them directly!'
    },
    EDIT: {
      BACK_WORKOUTS: 'Back to workouts',
      TITLE: 'Edit Workout',
  ...
  RESET_PASSWORD: {
    ...
    DESCRIPTION:
      'When creating a password, you should make sure that it consists of at least 6 characters, uppercase and lowercase letters. Not mandatory, just a recommendation 🙃',
    FORM: {
      CURRENT_PASSWORD: {
  ...
  AUTH: {
    ...
    FORGOT_PASSWORD: {
      ...
      DESCRIPTION:
        'Please enter the email address of the account you are trying to log in to. A password reset link will be sent to your e-mail address.',
    ...
    RESET_PASSWORD: {
      TITLE: 'Reset Password',
      DESCRIPTION:
        'It looks like you received the message we sent to your email address 🎉 Now you can create your new password.',
  ...
  WORKOUT_COMPLETED: {
    ...
    MOTIVATON_TEXT:
      'Today you kept up with your workout and gave it your all! Today you are better than yesterday, tomorrow you will be better than today!',
