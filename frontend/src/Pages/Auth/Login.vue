                ...
                <form  @submit="formSubmit($event)">
                    ...
                    <div class="mt-4">
                        ...
                        <div class="flex w-full justify-end">
                            <router-link to="/sifremi-unuttum" class="text-sm underline underline-offset-1">Şifremi Unuttum</router-link>
                        </div>
                    </div>

                    <div class="flex justify-end">
                        <ButtonCmp type="submit" class="bg-gray-800 hover:bg-gray-600 active:bg-gray-700 text-white mt-4 w-full text-lg">Giriş Yap</ButtonCmp>
                    </div>

                    <hr class="my-6 border-gray-300 w-full">

                    <ButtonCmp  class="w-full bg-white hover:bg-gray-100 focus:bg-gray-100 text-gray-900 font-semibold rounded-lg border border-gray-300">
                    ...
                    <div class="mt-6 font-">
                        Üyeliğin yok mu? <router-link to="/uye-ol" class="font-semibold text-blue-400">Üye Ol</router-link>
                    </div>
