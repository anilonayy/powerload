            ...
            <LayoutContainer>
                ...
                <div v-if="isAuthenticated">
                    ...
                    <div class="relative inline-block text-left">
                        <button  @click="isOpen = !isOpen" id="dropdown-button" class=" inline-flex justify-center w-full px-4 py-2 text-sm font-semibold text-gray-700 bg-white border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-100 focus:ring-blue-500">
                            {{ userData.firstName }}
