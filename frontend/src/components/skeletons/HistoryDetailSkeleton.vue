<template>
    <div>
        <button class="inline-flex justify-center items-center rounded-lg text-sm py-2.5 px-4 border-2 font-semibold transition-all
            bg-gray-200 dark:bg-gray-700 mt-2 animate-pulse w-32 h-12
                ">
                </button>
