                                    ...
                                    <table>
                                        <tbody>
                                            <tr v-for="(log, logIndex) in data.exercise_logs" :key="logIndex">
                                                <td class=""> {{ logIndex + 1 }}. {{ $t('TRAIN_RESULT.SET') }}</td>
                                                <td class="ps-2">|</td>
                                                <td class="ps-4"> {{ log?.reps }}  </td>
                                                <td class="ps-4"> x  </td>
                                                <td class="ps-4"> {{ log?.weight }} {{ $t('TRAIN_RESULT.KG') }} </td>
                                            </tr>
                                        </tbody>
                                    </table>
